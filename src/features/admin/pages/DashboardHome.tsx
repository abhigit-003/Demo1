...
import { TrendingUp, Package, MapPin, IndianRupee, Users, ArrowUpRight, ArrowDownRight, Loader2 } from "lucide-react";
...
const DEFAULT_STATS = [
  { name: 'Total Revenue', value: '₹124,832', change: '+12.5%', trend: 'up', icon: IndianRupee, color: 'text-green-600', bgColor: 'bg-green-50' },
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={fetchStats} disabled={isLoading}
          className="inline-flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 text-sm text-gray-700 disabled:opacity-60">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <button onClick={() => navigate('/admin/pricing-rules')} className="bg-white border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-green-500 hover:bg-green-50 transition-colors text-left">
          <IndianRupee className="w-8 h-8 text-gray-400 mb-3" />
