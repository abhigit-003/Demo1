        ...
        <nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-raffine-burgundy text-raffine-gold font-display antialiased">
            <div className="px-6 md:px-12 py-5 flex items-center justify-between max-w-[1536px] mx-auto">
                ...
                <div className="flex items-center gap-1 md:gap-4 shrink-0 text-white">
                    ...
                    <Link to="/wishlist" className="relative hidden sm:flex items-center justify-center size-10 rounded-full hover:bg-white/5 transition-colors" aria-label="Wishlist">
                    ...
                    {user ? (
                        ...
                        <Link
                            to="/login"
                            className="hidden sm:flex items-center justify-center size-10 rounded-full hover:bg-white/5 transition-colors text-white"
                            aria-label="Login"
                        >
                            <User className="size-[22px] stroke-[1.5px]" />
                        </Link>
                        ...
                        <div className="flex flex-col p-8 gap-8">
                            ...
                            <div className="pt-8 border-t border-white/5 flex gap-8 items-center">
                                ...
                                {user ? (
                                    ...
                                    <Link to="/login" onClick={() => setIsMobileMenuOpen(false)} className="text-white"><User /></Link>
                                )}
                            </div>
                        </div>
                    </div>
